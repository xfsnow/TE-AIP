...
<details markdown="block">
<summary><strong>Expand this section to view the solution</strong></summary>
**Note**: If you use Microsoft internal subscriptions, you may need to encounter public network access of cosmos db is disabled even after you enabled. Please check and enable public network access of cosmos db before running the following tests.
...
```json
{
    ...
    "ConnectionStrings": {
      "ContosoSuites": "https://cosmos-example.documents.azure.com:443/"
    },
